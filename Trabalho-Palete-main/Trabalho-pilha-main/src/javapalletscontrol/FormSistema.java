...
public class FormSistema extends javax.swing.JFrame {
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        while(!minhaPilha.isEmpty()){
          p = minhaPilha.peek();//retorna o elemento mais recente adicionado à pilha sem removê-lo
          if(p.getDescricao().equals(txtProduto.getText())){
              p = minhaPilha.pop();
              int n=Integer.parseInt( txtQtd.getText()) ;
               //n passa a ser quantidade do meu produto
              //if(p.getQuantidade()>= Integer.parseInt( txtQtd.getText())){
              if(p.getQuantidade()>=n){
                  JOptionPane.showMessageDialog(null, "Encontrado");
                  p.setQuantidade (p.getQuantidade() - n );
                  minhaPilha.push(p);//push: adiciona um novo elemento no topo da pilha.
                  mostraPilha(minhaPilha,listPilha);
                  break;
                  ...
                  JOptionPane.showMessageDialog(null, "Quantidade de produto indisponivel");
                  
              }
              //if(p.getQuantidade >=p.getQtd  )
              ...
              pilhaAuxiliar.push(minhaPilha.pop());//pop: remove o elemento mais recente adicionado à pilha.
